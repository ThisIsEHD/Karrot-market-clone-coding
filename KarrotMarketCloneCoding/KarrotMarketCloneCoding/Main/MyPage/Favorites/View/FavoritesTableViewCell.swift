...
class FavoritesTableViewCell: UITableViewCell {
    ...
    private let favoriteHeartButton = UIButton()
   
    
    // MARK: - Actions
    
    @objc
    private func favoriteHeartButtonDidTapped() {
        print(#function)
    }
    ...
    private func setupButtons() {
        ...
        favoriteHeartButton.addTarget(self, action: #selector(favoriteHeartButtonDidTapped), for: .touchUpInside)
    }
